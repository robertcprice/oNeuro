...
pub use whole_cell_data::{
    ...
    WholeCellLocalChemistryConfig, WholeCellLocalChemistrySpec, WholeCellMoleculePoolSpec,
    WholeCellOperonSpec, WholeCellOrganismExpressionState, WholeCellOrganismProfile,
